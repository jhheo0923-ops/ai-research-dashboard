...
- arXiv `cs.AI`, `cs.LG`, `cs.CL`, `cs.CV`, `cs.RO` 최신 논문 수집
...
- 28일 수집량, 자료·소스 구성, 1차→2차 분류 지도를 제공하는 통계 탭
- 중요도·키워드·헤드라인 중심의 카드 뉴스와 기기별 읽음·별표 관리
- 12개 대표 학회의 논문 접수·결과 발표·워크샵·본학회 연간 타임라인
