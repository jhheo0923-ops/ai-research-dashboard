...
- arXiv 핵심 5개 분야의 최신 논문과 13개 공식 세부 카테고리의 2022년 이후 연간 등록 수 수집
...
- 28일 수집량, 정확한 수치를 함께 표시하는 5개년 분야별 arXiv 막대그래프, 자료·소스 구성, 1차→2차 분류 지도를 제공하는 통계 탭
...
카드의 한국어 분석은 별도 유료 API 없이 제목·초록의 연구 신호와 계층형 분류를 조합해 개요, 연구 동기, 핵심 기여로 나누어 생성합니다. 따라서 번역문이 아니라 연구 질문과 기여 유형을 빠르게 파악하기 위한 구조화된 한국어 다이제스트입니다. 연도별 통계는 arXiv의 공식 연도별 카테고리 목록에 표시되는 13개 분야의 등록 수를 사용하며, 하나의 공통 축에서 연도별 13개 막대를 차례로 비교합니다. 현재 연도는 연중 누적이며 교차 등록 논문은 여러 카테고리에 중복 집계될 수 있습니다.
